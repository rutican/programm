...
CRecvSok::CRecvSok()
{
	//NOVAYA_IGRA=0;// не было вопроса о нач новой игры
}
...
void CRecvSok::OnClose(int nErrorCode)
{
	// TODO: Add your specialized code here and/or call the base class
			AfxMessageBox("Клиетн вышел из сетевой игры",0,0);
	CMainFrame* pMF;
...
void CRecvSok::OnReceive(int nErrorCode)
{
	...
	for(int i=0; i<9; i++)
	{
		...
		if(SUM==99){
			...
			if(IDOK==AfxMessageBox("Вы хотите начать новую игру??",MB_OKCANCEL,0)){
